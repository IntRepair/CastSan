...
def is_on_basti_ga():
  return get_hostname() == "w0xel-pc"

def is_on_basti_nb():
  return get_hostname() == "basti-asus"
...
def read_config():
  ...
  elif is_on_basti_ga(): # basti
    clang_config = {
      "LLVM_DIR"           : os.environ["HOME"] + "/Projects/CastSan/git/CastSan",
      "LLVM_BUILD_DIR"     : os.environ["HOME"] + "/Projects/CastSan/git/CastSan/build",
      "BINUTILS_BUILD_DIR" : os.environ["HOME"] + "/Projects/CastSan/git/CastSan/binutils/build",
      "SD_DIR"             : os.environ["HOME"] + "/Projects/CastSan/git/CastSan/scripts",
      "MY_GCC_VER"         : "4.9.2"
    }
  elif is_on_basti_nb(): # basti notebook
    clang_config = {
      "LLVM_DIR"           : os.environ["HOME"] + "/Repos/llvm_pass",
